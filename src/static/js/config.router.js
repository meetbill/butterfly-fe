...
function ($stateProvider, $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
    ...
    $stateProvider.state('app', {
        ...
        url: '/echarts',
        templateUrl: 'static/tpl/ui_echarts.html',
        resolve: load(['angular-echarts', 'static/js/controllers/echarts.js'])
    })
    // table
    .state('app.table', {
        url: '/table',
    ...
    .state('layout', {
        ...
        resolve: load(['com.2fdevs.videogular', 'com.2fdevs.videogular.plugins.controls', 'com.2fdevs.videogular.plugins.overlayplay', 'com.2fdevs.videogular.plugins.poster', 'com.2fdevs.videogular.plugins.buffering', 'static/js/app/music/ctrl.js', 'static/js/app/music/theme.css'])
    }).state('music.home', {
        url: '/home',
